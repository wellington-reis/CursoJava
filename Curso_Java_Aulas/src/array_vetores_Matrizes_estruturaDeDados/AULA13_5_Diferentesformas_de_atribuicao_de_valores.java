...
public class AULA13_5_Diferentesformas_de_atribuicao_de_valores {
	 ...
	 *Para recuperar esses valores � igualmente ao array convencional.
	 *OBS: CADA DADO DEVE SER REPRENSENTANDO POR UMA STRING SEPARADO POR VIRGULA.*/
	
		
	for (int i = 0; i < valores2.length; i++) {
		
		System.out.println("Os Valores do array na posi��o " + i + "� = " + valores2[i]);
		System.out.println("----------------------------");
	}
